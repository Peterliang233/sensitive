...
// Add 添加若干个词到敏感词集合
func (tree *Trie) AddBody(reader io.Reader) error {
...
// Filter 直接过滤掉字符串中的敏感词，返回过滤后的字符串
...
func (tree *Trie) LoadDict(path string) error {
	f, err := os.Open(path)
